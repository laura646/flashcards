...
// ═══════════════════════════════════════════════════════════════
// /admin-beta/help — admin documentation page (10B redesign)
//
...
// Internal /admin/* links repointed to /admin-beta/*. The mockup boxes
  ...
  return (
    <Section id="getting-started" icon="🚀" title="Getting started">
      ...
      <ol className="list-decimal pl-5 space-y-1.5">
        <li>
          <span className="font-bold">Authoring</span> — open <Link href="/admin-beta/lessons" className="text-sky-text hover:underline">Lessons</Link> to build flashcards + exercises for your students.
        </li>
        <li>
        ...
        <li>
          <span className="font-bold">Insight</span> — open <Link href="/admin-beta/reports" className="text-sky-text hover:underline">Reports</Link> to see who&apos;s struggling, what they&apos;re struggling with, and how the class is trending overall.
        </li>
      </ol>
      <Tip>
...
function CoursesSection() {
  return (
    <Section id="courses" icon="📚" title="Courses">
      <p>
        <Link href="/admin-beta/courses" className="text-sky-text hover:underline">My Courses</Link> lists
...
function StudentsSection() {
  return (
    <Section id="students" icon="👥" title="Students">
      <p>
        <Link href="/admin-beta/students" className="text-sky-text hover:underline">My Students</Link> lists
...
function LessonsSection() {
  return (
    <Section id="lessons" icon="📖" title="Lessons &amp; exercises">
      <p>
        <Link href="/admin-beta/lessons" className="text-sky-text hover:underline">Lessons</Link> is where
...
function TestsSection() {
  return (
    <Section id="tests" icon="📝" title="Tests">
      ...
      <Tip>
        If a student says &quot;I had network issues, can I retry?&quot; — open <Link href="/admin-beta/reports" className="text-sky-text hover:underline">Reports</Link>, find their detail view, scroll to Tests, click ↺ Reset on the right test.
      </Tip>
    </Section>
  )
}
...
function AttendanceSection() {
  return (
    <Section id="attendance" icon="✅" title="Attendance">
      <p>
        <Link href="/admin-beta/attendance" className="text-sky-text hover:underline">Attendance</Link> lets
      ...
      <p>
        Attendance % shown in <Link href="/admin-beta/reports" className="text-sky-text hover:underline">Reports</Link> = (present + late) ÷ marked sessions.
      </p>
      <Tip>
...
function ReportsSection() {
  return (
    <Section id="reports" icon="📊" title="Reports">
      <p>
        <Link href="/admin-beta/reports" className="text-sky-text hover:underline">Reports</Link> is the
...
function ContentBankSection() {
  return (
    <Section id="content-bank" icon="🗃️" title="Content Bank">
      <p>
        <Link href="/admin-beta/content-bank" className="text-sky-text hover:underline">Content Bank</Link> is
